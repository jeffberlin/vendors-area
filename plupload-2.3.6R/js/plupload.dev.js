...
plupload.Uploader = function(options) {
	...
	*/
	...
	function onUploadFile(up, file) {
		...
		var offset = 0;
		var blob;
      var serverOffsetRequestDone // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
		...
		function uploadNextChunk() {
            ...
            if (serverOffsetRequestDone) { // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
               chunkBlob = blob.slice(offset, offset + curChunkSize);
            }                              // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
			} else {
			...
			if (chunkSize && features.chunks) {
               ...
               args.partitionIndex = args.chunk; // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
		...
		function uploadChunk(args, chunkBlob, curChunkSize) {
			...
			xhr.onload = function() {
               ...
               if (xhr.status == 400) {                                           // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                  serverOffsetRequestDone = false;                                // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
               }                                                                  // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
					handleError();
					return;
				}
            ...
            if (curChunkSize < blob.size) {
               ...
               if (!serverOffsetRequestDone) {                                    // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                  serverOffsetRequestDone = true;                                 // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                  if (xhr.responseText != null) {                                 // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                     var s = xhr.responseText.split(':');                         // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                     if ((s.length == 2) && (s[0].trim() == 'partitionIndex')) {  // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                        offset = chunkSize * parseInt(s[1].trim ());              // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                     }                                                            // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                  }                                                               // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                  delay(uploadNextChunk, 1);                                      // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
                  return;                                                         // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
               }                                                                  // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
            ...
            if (chunkBlob != null) { // 9/21/2015 PN : BMT Micro Addition for JumpLoader resume compatibility
...
plupload.File = (function() {
	...
	function PluploadFile(file) {
		...
		plupload.extend(this, {
         ...
         lastModifiedDate: file.lastModifiedDate, // 7/11/2018 PN : Bugfix!
