                ...
                <form method="post" name="discform" action="https://vendors-new.bmtmicro.com/servlets/Vendors.DiscountSchemes">
                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="nameTab" role="tabpanel" aria-labelledby="name-tab">
                      ...
                      <span>
                        <label>Name:&nbsp;</label>
                        <input id="NAME" name="NAME" maxlength="80" value="<%= request.getParameter ("NAME") %>" type="text" style="width: 275px; margin-bottom: 2rem;">
                    ...
                    <div class="tab-pane fade" id="amountTab" role="tabpanel" aria-labelledby="amount-tab">
                      ...
                      <span>
                        <label>Amount:&nbsp;</label>
                        <input id="AMOUNT" name="AMOUNT" type="text" value="<%= request.getParameter ("AMOUNT") %>" style="width: 100px; margin-right: 1rem;" />
                      </span>
                      <span>
                        <label>Method:&nbsp;</label>
                    ...
                    <div class="tab-pane fade" id="expirationSettings" role="tabpanel" aria-labelledby="expiration-tab">
                      ...
                      <span>
                        ...
                        <input id="DATEFROM" name="DATEFROM" value="<%= request.getParameter ("DATEFROM") %>" type="text" style="margin-bottom: 1rem;">
                      ...
                      <span>
                        ...
                        <input id="DATETO" name="DATETO" value="<%= request.getParameter ("DATETO") %>" type="text" style="margin-bottom: 2rem;">
                    ...
                    <div class="tab-pane fade" id="quantity" role="tabpanel" aria-labelledby="quantity-tab">
                      ...
                      <span>
                        ...
                        <input id="QUALIFYINGQUANTITY" name="QUALIFYINGQUANTITY" value="<%= request.getParameter ("QUALIFYINGQUANTITY") %>" type="text" style="width: 100px;">
