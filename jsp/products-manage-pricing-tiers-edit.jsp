                  ...
                  <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="qualifyingTab" role="tabpanel" aria-labelledby="qualifying-tab">
                      ...
                      <div class="move">
                        ...
                        <button style="margin-right: 5px;" name="Remove" value="&lt;&lt;&nbsp;Remove" onclick="removeQualifyingProduct(tierform);return (false);">
                          <i class="fas fa-angle-up"></i>&nbsp;Remove
                        </button>
                        <button style="margin-right: 5px;" name="Add" value="Add&nbsp;&gt;&gt;" onclick="addAllQualifyingProducts(tierform);return (false);">
                          Add&nbsp;All&nbsp;<i class="fas fa-angle-down"></i>
                        </button>
                        <button name="Remove" value="&lt;&lt;&nbsp;Remove" onclick="removeAllQualifyingProducts(tierform);return (false);">
                    ...
                    <div class="tab-pane fade" id="discountedTab" role="tabpanel" aria-labelledby="discounted-tab">
                      ...
                      <div class="move">
                        ...
                        <button style="margin-right: 5px;" name="Remove" value="&lt;&lt;&nbsp;Remove" onclick="removeDiscountProduct (tierform);return (false);">
                          <i class="fas fa-angle-up"></i>&nbsp;Remove
                        </button>
                        <button style="margin-right: 5px;" name="Add" value="Add&nbsp;&gt;&gt;" onclick="addAllDiscountProducts (tierform);return (false);">
                          Add&nbsp;All&nbsp;<i class="fas fa-angle-down"></i>
                        </button>
                        <button name="Remove" value="&lt;&lt;&nbsp;Remove" onclick="removeAllDiscountProducts (tierform);return (false);">
                          <i class="fas fa-angle-up"></i>&nbsp;Remove&nbsp;All
                        </button>
                      </div> <!-- end .move -->
                      ...
                      <div class="controlbuttons">
                        ...
                        <button type="button" onclick="submitForm (tierform);" value="Save" class="save-btn" style="margin-right: .3rem;">Save</button>
                        <button type="reset" onclick="history.back ();" value="Reset" class="save-btn">Reset</button>
                      </div>
                    </div> <!-- end .tab-pane -->
                  </div> <!-- end .tab-content -->
                </div> <!-- end .tab-box -->
