...
<html lang="en">
  <head>
    ...
    <%-- <script language="javascript" type="text/javascript" src="https://vendors-new.bmtmicro.com/js/simpletreemenu.js"></script> --%>
            ...
            <div class="col-lg-10 col-md-12 page-title">
              ...
              <div class="content-box">
                <form name="orderlistform" action="https://vendors-new.bmtmicro.com/servlets/Vendors.ImportRipOrders" method="post">
                  ...
                  <input type="hidden" name="ERROR_PAGE" value="https://vendors-new.bmtmicro.com/error.jsp">
                  <input type="hidden" name="SUBMISSIONID" value="<%= request.getParameter ("SUBMISSIONID") %>">
                ...
                <form action="https://vendors-new.bmtmicro.com/servlets/Vendors.ImportRipOrders" method="post" target="detailsPopUp">
                  ...
                  <input type="hidden" name="RIPCODE" value="<%= request.getParameter ("RIPCODE") %>">
