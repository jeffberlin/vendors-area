...
<html lang="en">
    ...
    <script src="https://vendors.bmtmicro.com/js/vhelp.js"></script>
    <script src="https://vendors.bmtmicro.com/js/tablesort.js"></script>
    ...
    <script>
	    function doAction(action, target) {
	      ...
	      form.target = target;
        if (target == "_parent") {
          form.ERROR_PAGE.value = "https://vendors.bmtmicro.com/error.jsp";
          form.submit ();
        } else {
          form.target = "";
              ...
              <div class="content-box overflow-auto d-flex flex-column">
                <div name="tableframe" class="overflow-auto h-100" id="tableframe">
                  <c:catch var="errormsg">
                    <c:import url="https://vendors.bmtmicro.com/servlets/Vendors.ImportRipOrders">
	                    <c:param name="SESSIONID" value="${sessionid}" />
		                  <c:param name="STARFILE" value="https://vendors.bmtmicro.com/images/star.gif" />
		                  <c:param name="BLANKFILE" value="https://vendors.bmtmicro.com/images/blank.gif" />
		                  <c:param name="ACTION" value="1" />
											<c:param name="ACTION2" value="9" />
		                  <c:param name="NEXT_PAGE" value="https://vendors.bmtmicro.com/rip-import-table.jsp" />
		                  <c:param name="DONE_PAGE" value="https://vendors.bmtmicro.com/rip-import-no-more-orders.jsp" />
		                </c:import>
                  </c:catch>
