...
<div class="container-fluid" style="padding-left: 0; padding-right: 0;">
	...
	<div class="buttons">
		...
		<button type="button" onclick="initFields ('${param.FIELDIDLIST}');" class="grey-btn">Reset</button>
		<button type="button" onclick="initFields ('${param.DEFAULTFIELDIDLIST}');" class="grey-btn">Default</button>
