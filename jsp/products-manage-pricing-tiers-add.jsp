                ...
                <form method="post" name="tierform" action="https://vendors-new.bmtmicro.com/servlets/Vendors.TieredPricing">
                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="basicTab" role="tabpanel" aria-labelledby="basic-tab">
                      ...
                      <span>
                        <label>Name:&nbsp;</label>
                        <input type="text" id="NAME" name="NAME" maxlength="80" value="${requestScope.NAME}" style="margin-bottom: 2rem;"/>
                        &nbsp;&nbsp;
                    ...
                    <div class="tab-pane fade" id="amountTab" role="tabpanel" aria-labelledby="amount-tab">
                      ...
                      <span>
                        ...
                        <select name="ROUNDING">
                          <option value="-1.00"<c:if test="${requestScope.ROUNDING=='-1.00'}"> selected</c:if>>Round discount</option>
                          <option value="1.00"<c:if test="${requestScope.ROUNDING=='1.00'}"> selected</c:if>>Round price</option>
                        ...
                        <select name="ROUNDING" style="margin-bottom: 2rem;">
                          <option value="0.05"<c:if test="${requestScope.ROUNDING=='0.05'}"> selected</c:if>>0.05</option>
                          <option value="0.10"<c:if test="${requestScope.ROUNDING=='0.10'}"> selected</c:if>>0.10</option>
                          <option value="0.25"<c:if test="${requestScope.ROUNDING=='0.25'}"> selected</c:if>>0.25</option>
                          <option value="0.50"<c:if test="${requestScope.ROUNDING=='0.50'}"> selected</c:if>>0.50</option>
                          <option value="1.00"<c:if test="${requestScope.ROUNDING=='1.00'}"> selected</c:if>>1.00</option>
                        </select>
                      </span>
                      <br>
                    ...
                    <div class="tab-pane fade" id="quantityTab" role="tabpanel" aria-labelledby="quantity-tab">
                      ...
                      <span>
                        ...
                        <input type="text" id="QUALIFYINGQUANTITY" name="QUALIFYINGQUANTITY" value="${requestScope.QUALIFYINGQUANTITY}"  style="max-width: 75px; margin-bottom: 1rem;" />
