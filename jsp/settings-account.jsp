...
<br clear="all">
<span>
  <input type="hidden" name="VENDORMAIL" value="${requestScope.VENDORMAIL}" />
  <input type="checkbox" style="margin-bottom: 1rem;"<c:if test="${requestScope.VENDORMAIL!=0}"> checked</c:if>/>&nbsp;Receive updates from BMT
</span>
<br clear="all">
<span>
