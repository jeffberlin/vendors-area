          ...
          <div class="row justify-content-start">
            <div class="col-lg-2">
              <aside class="sidebar" role="complementary">
                ...
                <div>
                  <a class="sidebar-group" href="https://vendors-new.bmtmicro.com/login-lost-password.jsp">Lost your password?</a>
                </div>
                <div>
            ...
            <div class="col-lg-10 col-md-12 page-title">
              <form name="form1" method="post" action="https://vendors-new.bmtmicro.com/servlets/Vendors.Signup">
                <input type="hidden" name="NEXT_PAGE" value="https://vendors-new.bmtmicro.com/new-vendor-account-setup.jsp" />
                ...
                <p>Here is a copy of our basic <a href="NewSignup/GenericVendorAgreement.pdf" target="_blank">Vendor Agreement</a>. If your bank requires this, please sign and fax to: (910) 792-1889.</p>
                <span>
