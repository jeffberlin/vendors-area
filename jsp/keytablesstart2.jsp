...
<html lang="en">
  ...
  <body onload="document.start.submit();">
    ...
    <div class="main-raised">
      ...
      <form name="start" method=post action="https://vendors-new.bmtmicro.com/servlets/Vendors.RegistrationKeys" target="tableframe">
        <input type="hidden" name="ACTION" value="-1" />
        <input type="hidden" name="ROWTEMPLATEURL" value="https://vendors-new.bmtmicro.com/keytables_tablerow.html" />
        <input type="hidden" name="NEXT_PAGE" value="https://vendors-new.bmtmicro.com/keytables.html">
