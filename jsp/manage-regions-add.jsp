...
<div class="transfer-section">
  <form method="post" name="addregion" action="https://vendors-new.bmtmicro.com/servlets/Vendors.WorldRegions">
    ...
    <div class="controlbuttons">
      <button type="button" class="save-btn" onclick="submitRegion (document.addregion);" style="margin-right: .5rem;">Save</button>
