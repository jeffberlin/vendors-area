        ...
        <article class="section">
          <div class="row justify-content-start">
            ...
            <div class="col-lg-10 col-md-12 page-title">
              ...
              <form name="start" method=post action="https://vendors-new.bmtmicro.com/servlets/Vendors.Affiliates" target="tableframe">
                <input type="hidden" name="ACTION" value="-1" />
                <input type="hidden" name="MAXAMOUNT" value="" />
                <input type="hidden" name="ROWTEMPLATEURL" value="https://vendors-new.bmtmicro.com/affiliateinfo_tablerow.html" />
                <input type="hidden" name="NEXT_PAGE" value="https://vendors-new.bmtmicro.com/affiliateinfo.html">
