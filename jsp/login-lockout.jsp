        ...
        <div class="row justify-content-center">
          <div class="box-style">
            <div class="vendor-login-box" style="background-color: rgba(255,255,255,0.3);">
              ...
              <p>You have been locked out due to excessive incorrect login and/or password entries.</p>
              <p>Please contact&nbsp;<a href="mailto:vendors@bmtmicro.com?subject=Vendor Locked Out">vendors@bmtmicro.com</a>&nbsp;for assistance.</p>
            </div>
          </div>
        </div>
      </div>
