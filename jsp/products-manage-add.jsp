  ...
  <head>
    ...
    <script>
      ...
      function submitForm (form) {
        ...
        if ("${requestScope.DATEDISCONTINUED}" != "") {
                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                      ...
                      <span>
                        ...
                        <input type="text" name="PRODUCTNAME" value="${requestScope.PRODUCTNAME}" style="margin-right: .5rem; margin-bottom: 1rem;">
                      </span>
                      <br>
                      <span>
                      ...
                      <span>
                        ...
                        <input type="checkbox"<c:if test="${requestScope.PRICEINCLUDESGST!=0}"> checked</c:if>/>&nbsp;The price includes GST
                      </span>
                      <br clear="all">
                      <span>
                        <label style="margin-bottom: .2rem;">Short&nbsp;Description:</label>
                        <br>
                        <textarea name="DESCRIPTION" id="DESCRIPTION" onkeydown="textLimiterAndCounter(this.form.DESCRIPTION,this.form.CHARSREMAINING,1024);" onkeyup="textLimiterAndCounter(this.form.DESCRIPTION,this.form.CHARSREMAINING,1024);" cols="50" rows="4" placeholder="Type a message">${requestScope.DESCRIPTION}</textarea>
                      </span>
                      <span>
                    ...
                    <div class="tab-pane fade" id="productFormat" role="tabpanel" aria-labelledby="productFormat-tab">
                      ...
                      <span>
                        ...
                        <input name="FILEFORMATS" size="40" maxlength="80" value="${requestScope.FILEFORMATS}" />
                    ...
                    <div class="tab-pane fade" id="options" role="tabpanel" aria-labelledby="options-tab">
                      ...
                      <span>
                        ...
                        <input type="checkbox"<c:if test="${requestScope.SHOWCDOPTION!=0}"> checked</c:if>/>&nbsp;Show Backup CD option<br />
                      ...
                      <div id="shipping" class="toggle-section"<c:if test="${requestScope.SHIPPED==0}">style="display: none;"</c:if>>
                        <label>Shipping&nbsp;Cost&nbsp;Scheme:</label>
                        <select name="SHIPPINGCOSTSCHEMEID">
                          ${requestScope.SHIPPINGSCHEMEIDLIST}
                        </select>
                    ...
                    <div class="tab-pane fade" id="fulfillment" role="tabpanel" aria-labelledby="fulfillment-tab">
                      ...
                      <div id="keygenerator" class="toggle-section"<c:if test="${empty requestScope.KEYGENERATOR}">style="display: none;"</c:if>>
                        ...
                        <br clear="all">
                        <span>
                          <input type="checkbox" name="USEONEKEY_CHK2" size="12" onclick="document.productform.USEONEKEY_CHK.checked = this.checked;"<c:if test="${requestScope.USEONEKEY != 0}"> checked</c:if>/>&nbsp;Generate only one code for quantity purchases.
                        </span>
                      ...
                      <div id="discounts" class="toggle-section"<c:if test="${empty requestScope.DISCOUNTSCHEMEID}">style="display: none;"</c:if>>
                        ...
                        <span>
                          ...
                          <select name="DISCOUNTSCHEMEID">
                            ...
                            ${requestScope.DISCOUNTSCHEMEIDLIST}
                          </select>
                        </span>
                      </div> <!-- end .toggle-section -->
                      ...
                      <div id="affiliateinfo" class="toggle-section"<c:if test="${empty requestScope.AFFILIATEPERCENTAGE && empty requestScope.VENDORPRODUCTURL && empty requestScope.SECUREORDERURL && empty requestScope.DEMOURL}">style="display: none;"</c:if>>
                        ...
                        <span>
                          ...
                          <input type="checkbox" style="margin-bottom: .5rem;"<c:if test="${requestScope.INCLUDEONAPLIST!=0}"> checked</c:if>/>&nbsp;Include in All Affiliates List
                        </span>
                        <br clear="all">
                        <span>
                      ...
                      <div id="ordernotifications" class="toggle-section"<c:if test="${empty requestScope.NOTIFICATIONEMAILS && empty requestScope.NOTIFICATIONURL}">style="display: none;"</c:if>>
                        ...
                        <span>
                          ...
                          <input name="NOTIFICATIONEMAILS" size="50" value="${requestScope.NOTIFICATIONEMAILS}" maxlength="200" placeholder="example@domain.com" style="margin-bottom: 1rem;"/>
