...
<div class="transfer-section">
  <form method="post" action="https://vendors-new.bmtmicro.com/servlets/Vendors.V2VTransfer">
    ...
    <span>
      ...
      <input name="TOAFFILIATEID" maxlength="8" size="8" value="${requestScope.TOAFFILIATEID}" title="This should be the affiliate ID credited with this transfer." style="margin-bottom: .8rem;" />
    </span>
    <c:choose>
