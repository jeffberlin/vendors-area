  ...
  <head>
    ...
    <script language="javascript" type="text/javascript">
      ...
      function submitForm (form) {
        ...
        if (!(checkPayOutMinAmt (form.PAYOUTMINAMT, form.PAYOUTMETHOD) &&
        checkPayOutMinAmt (form.PAYOUTMINAMT_USD, form.PAYOUTMETHOD_USD) &&
        checkPayOutMinAmt (form.PAYOUTMINAMT_EUR, form.PAYOUTMETHOD_EUR) &&
        checkPayOutMinAmt (form.PAYOUTMINAMT_GBP, form.PAYOUTMETHOD_GBP))) {
          return (false);
        }
            ...
            <div id="account-page" class="col-lg-10 col-md-12 page-title" id="account-page">
              ...
              <div class="content-box">
                <form name="account" method="post" action="https://vendors-new.bmtmicro.com/servlets/Vendors.Account">
                  ...
                  <input type="hidden" name="PAYOUTMETHOD" value="${param.PAYOUTMETHOD}" />
                  <input type="hidden" name="PAYOUTMETHOD_USD" value="${param.PAYOUTMETHOD_USD}" />
                  <input type="hidden" name="PAYOUTMETHOD_EUR" value="${param.PAYOUTMETHOD_EUR}" />
                  <input type="hidden" name="PAYOUTMETHOD_GBP" value="${param.PAYOUTMETHOD_GBP}" />
